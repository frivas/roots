...
const recordTypeOptions = [
  ...
  { value: 'Educación Secundaria Obligatoria', label: 'Secondary Education' },
  { value: 'Educación Primaria', label: 'Primary Education' }
];
                      ...
                      <div className="min-w-[600px]">
                        ...
                        <div className="bg-white rounded-b-lg border border-t-0">
                          {record.subjects.map((subject, index) => (
                            ...
                            >
                              <div className="text-sm text-foreground">{subject.name}</div>
